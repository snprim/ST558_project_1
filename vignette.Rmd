...
Note: If you would like information for more than one team, enter `teamId`. If you want specific information, such as roster, enter `ID` and select one team at a time.  

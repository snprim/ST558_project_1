...
# test3 <- GET("https://statsapi.web.nhl.com/api/v1/teams/20?expand=person.names") %>% content("text") %>% fromJSON(flatten = TRUE)
# test3 <-as.data.frame(test3$teams)
test4 <- GET("https://statsapi.web.nhl.com/api/v1/teams/54?expand=team.schedule.next") %>% content("text") %>% fromJSON(flatten = TRUE)
test4 <- test4$teams$nextGameSchedule.dates
test4<- as.data.frame(test4[[1]]$games)
# test5 <- GET("https://statsapi.web.nhl.com/api/v1/teams/54?expand=team.stats") %>% content("text") %>% fromJSON(flatten = TRUE)
# test5 <- test5$teams$teamStats[[1]]$splits[[1]]
test6 <- GET("https://statsapi.web.nhl.com/api/v1/teams/54?expand=team.schedule.previous") %>% content("text") %>% fromJSON(flatten = TRUE)
test6 <- test6$teams$previousGameSchedule.dates
test6 <- as.data.frame(test6[[1]]$games)
# test7 <- GET("https://statsapi.web.nhl.com/api/v1/teams/20?expand=team.roster&season=20142015") %>% content("text") %>% fromJSON(flatten = TRUE)
# test7 <- test7$teams
...
# test9 <- test9$teams
# need to change nextGameSchedule and previousGameSchedule in case no info 
# make a table for id and franchiseId?
```
...
getStats(teamID = 53, expand = "team.roster") %>% tbl_df()
